...
import { CombinePainter } from "./CombineCompositePainter";
import { PainterScheduler } from "./PainterScheduler";
...
export class CompositePainterFactory {
    ...
    static combinePainters(painters: ProportionalPainter[]): IPainter {
        ...
        return new CombinePainter<ProportionalPainter>(painters, new PainterScheduler());
    }
